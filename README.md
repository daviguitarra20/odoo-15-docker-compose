...
``` bash
curl -s https://raw.githubusercontent.com/daviguitarra20/odoo-15-docker-compose/refs/heads/master/run.sh | sudo bash -s odoo-one 10015 20015
```
...
``` bash
curl -s https://raw.githubusercontent.com/daviguitarra20/odoo-15-docker-compose/refs/heads/master/run.sh | sudo bash -s odoo-two 11015 21015
```
...
``` sh
$ git clone https://github.com/daviguitarra20/odoo-15-docker-compose
